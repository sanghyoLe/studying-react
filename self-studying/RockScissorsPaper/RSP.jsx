...
class RSP extends PureComponent {
  ...
  componentDidMount() { // 컴포넌트 첫 렌더링 된 후 -> 비동기 요청을 많이 함 setInterval()
    // 비동기 함수 밖에 있는 변수 참조하면 클로저 문제 발생 ( Javascript )
    this.interval = setInterval(this.changeHand,100)
  }
  componentWillUnmount() { // 컴포넌트 제거되기 직전 , 비동기 요청 정리 clearInterval()
